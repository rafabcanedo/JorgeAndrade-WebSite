...
const About = () => {
 ...
 return(
  <div className="mt-8">
    ...
    <div>
      <h1 className="text-2xl text-white font-semibold">Evento <span className="text-[#f5d600] text-2xl font-semibold">Now</span></h1>
      <span className="text-lg text-white">Um evento transformador, liberado por Roberto Shinyashiki 
    ...
    <div className="container mx-auto grid md:grid-cols-2 items-center md:justify-between mt-16">
     <div>
     <h1 className="text-2xl text-white font-semibold">Podcast <span className="text-[#f96d00] text-2xl font-semibold">Papo Reto</span></h1>
     <span className="text-white text-lg">Diretamente de Bauru, o podcast Papo Reto
     ...
     <button className="relative text-white font-semibold bg-[#f96d00] hover:bg-[#e8751a] py-2 px-4 rounded-lg">
    ...
    <span className="font-bold text-subtitle mt-4">Por que decidi seguir com as <span className="text-primary">Mentorias?</span></span>
